...
import com.alibaba.datax.core.transport.exchanger.RecordExchanger;
        ...
        private AbstractRunner generateRunner(PluginType pluginType) {
            ...
            switch (pluginType) {
                case READER:
                    ...
                    recordSender = new RecordExchanger(this.channel, pluginCollector);
                ...
                case WRITER:
                    ...
                    pluginCollector = ClassUtil.instantiate(
                            ...
                            configuration, this.taskCommunication,
                            PluginType.WRITER);
                    ((WriterRunner) newRunner).setRecordReceiver(new RecordExchanger(
